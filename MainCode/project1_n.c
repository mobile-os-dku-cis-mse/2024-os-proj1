...
// 스케줄링 방식 선택 변수
int scheduling_type = 0; // 1: RR, 2: FCFS, 3: SJF
int run_queue_size = NUM_CHILDREN;  // 초기에는 모든 프로세스가 run_queue에 존재
...
void FCFS_scheduler();              // FCFS 스케줄러 함수
void SJF_scheduler();               // SJF 스케줄러 함수
void handle_io();                   // I/O 처리 함수

// main 함수
int main()
{
    printf("Select Scheduling Algorithm: 1 for RR, 2 for FCFS, 3 for SJF: ");
...
void signal_handler(int signo) 
{
    ...
    switch (scheduling_type) {
        case 1: RR_scheduler(); break;
        case 2: FCFS_scheduler(); break;
        case 3: SJF_scheduler(); break;
    }
