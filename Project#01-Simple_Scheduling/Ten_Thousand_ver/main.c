...
int main(int argc, char *argv[]){
    ...
    for(int i = 0; i < MAX_PROCESSES; i++){
        ...
        enqueue(ready_queue, parent[i]->pid, parent[i]->original_cpu_burst, parent[i]->original_io_burst, parent[i]->cpu_burst, parent[i]->io_burst, 0, time_quantum);
    ...
    printf("Avg. Turnaround Time: %0.3f \n", turnaround_time / turn_proc_count);
    printf("=====================================\n");
